                          ...
                          if (validateForm()) {
                            if (selected) {
                              MovieModel newMovie = MovieModel(
                                  ...
                                  directorTextEditingController.text);
                              Provider.of<MovieListProvider>(
                                  context, listen: false).addMovie(newMovie);
                              showFlutterToast('Movie Added Successfully',
                                  AppColor.accentColor);
                              HiveDatabase hiveDb = HiveDatabase();
                              hiveDb.setData(Provider
                                  .of<MovieListProvider>(context, listen: false)
                                  .movieModelList);
